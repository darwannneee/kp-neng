...
export default function Home() {
  ...
  return (
    ...
    <main className={`${LoraFontBold.className}`}>
            ...
            {heroBanner && (
              ...
              >
                ...
                <button 
                  ...
                  onClick={() => router.push(`/productdetails/${heroBanner.product.id}`)}
                >
                  Beli Sekarang
                </button>
        </div>
                  ...
                  >
                    ...
                    <div className="relative z-10 flex flex-col items-center justify-center h-full w-full">
                      ...
                      <button
                        ...
                        onClick={() => router.push(`/productdetails/${banner.product.id}`)}
                      >
                        Beli Sekarang
                      </button>
          </div>
      ...
      {/* Section heading */}
      <h2 className="text-sm text-center md:text-left font-medium tracking-wider">CARI FAVORIT ANDA</h2>
      <h2 className="text-3xl pt-1 text-center md:text-left font-medium">Produk Baru</h2>
    ...
    >
      ...
      <div className="py-10">
        <button 
          ...
          className="block mx-auto px-6 py-2 border border-gray-300 rounded hover:bg-gray-50 transition"
        >
          Lihat Semua
        </button>
      </div>
    ...
    <div className="w-full px-4 sm:px-8 md:px-20 lg:px-32 xl:px-52 py-12">
      ...
      <div className="mt-6 md:mt-8">
        ...
        <button 
          ...
          className="mt-2 text-base font-medium hover:underline"
        >
          BELI SEKARANG
        </button>
      </div>
